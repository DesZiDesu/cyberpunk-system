# Cyberpunk System sources and scope

This is the source and scope record for the V1 Official Release (runtime build v3.14.0), reviewed through 2026-09-11. Cyberpunk System is an unofficial SillyTavern role-play extension. It contains attributed district references and owner-supplied property presets documented in their asset folders, but no copied game UI code or ripped inventory-icon archive. SVG symbols are original code. The detailed map uses attributed NC Zoning Board geometry and remotely loaded map tiles, described below.
...
- [CD PROJEKT RED's Patch 1.5 notes](https://www.cyberpunk.net/en/news/41435/patch-1-5-next-generation-update-list-of-changes) provide official apartment context. The extension's separate home storage, stack capacities, recipes, Living resource recovery, garage allocations, fuel/wear equations and prices are custom RP rules, not reproductions of the game's apartment bonuses or driving mechanics.
- [CD PROJEKT RED's Update 2.3 notes](https://www.cyberpunk.net/en/news/51674/update-2-3-patch-notes) distinguish official vehicle features from this extension's manually recorded trips. No AutoDrive, real-world GPS, live price lookup, relationship or reputation simulation is claimed by this release.
