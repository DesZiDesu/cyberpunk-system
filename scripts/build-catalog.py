...
(out/'src/runtime/rpg-catalog.js').write_text('/* Factual item IDs from AGIS source snapshot 103a6250; see docs/SOURCES.md. Technical labels are not verified display names. */\nglobalThis.CyberpunkCatalog = '+json.dumps({'version':1,'curated':curated,'records':list(entries.values()),'districts':districts},ensure_ascii=False,separators=(',',':'))+';\n')
