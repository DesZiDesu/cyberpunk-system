...
globalThis.CyberpunkShopsFactory = api => {
  ...
  function draw(force=true){
    ...
    host.querySelectorAll('[data-shop]').forEach(b=>b.onclick=()=>{try{
      ...
      if(action==='inspect-item'&&pick)api.itemDossier?.(pick.item,mode==='sell');
