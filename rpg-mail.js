...
globalThis.CyberpunkMailFactory = api => {
  ...
  async function requestReply(doc,regenerate=false) {
    ...
    const generate=(...args)=>api.request?api.request('mail',()=>ctx.generateQuietPrompt(...args)):ctx.generateQuietPrompt(...args);
